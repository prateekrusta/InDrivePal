...
const FindDriver = () => {
  return (
    ...
    <p style={{marginTop:-15}}>₹ 150</p>
    </div>
    <h3 style={{fontWeight: 300}}>Current Fair</h3>
    <div style={{ display: 'flex', alignItems: 'center' }}>
        <div className="btn-submit" style={{ backgroundColor: "#F5F5F5", border: 'none', width: '40vw', marginLeft: '5vw' }}><p>-10</p></div>
        <h3 style={{ margin: '0 10px', marginLeft: '5vw', marginRight: '5vw' }}>₹156</h3>

        <div className="btn-submit" style={{ backgroundColor: "#A7E92F", border: 'none', width: '40vw', padding:1, marginRight: '5vw' }}><p>+10</p></div>
    
      </div>  
      <center><div className="btn-submit" style={{ backgroundColor: "#F5F5F5", border:'none', padding:1, width:'90vw', marginTop:'1vh'}}><p>Raise Fair</p></div>
      </center>
    </div>
  );
};
